...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} 1:}
\PY{c+c1}{\PYZsh{} Завдання: Побудувати функцiю для обчислення значення функцiї Лаґерра за формулою (1.2) для довiльних t i n, }
\PY{c+c1}{\PYZsh{} а параметри задавати за замовчуванням: β = 2, σ = 4.}
\PY{c+c1}{\PYZsh{} У даній комірці ми обчислюємо значення функції Лагера для заданих параметрів, використовуючи рекурентну }
\PY{c+c1}{\PYZsh{} формулу. Потім тестуємо функцію.}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{t\PYZus{}max\PYZus{}wd} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{IntSlider}\PY{p}{(}\PY{n+nb}{min} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{max} \PY{o}{=} \PY{l+m+mi}{10}\PY{p}{,} \PY{n}{value} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{n\PYZus{}max\PYZus{}wd} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{IntSlider}\PY{p}{(}\PY{n+nb}{min} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{max} \PY{o}{=} \PY{l+m+mi}{15}\PY{p}{,} \PY{n}{value} \PY{o}{=} \PY{l+m+mi}{5}\PY{p}{)}

\PY{n}{ipywidgets}\PY{o}{.}\PY{n}{interact}\PY{p}{(}\PY{n}{laguerre\PYZus{}graph}\PY{p}{,} \PY{n}{T} \PY{o}{=} \PY{n}{t\PYZus{}max\PYZus{}wd}\PY{p}{,} \PY{n}{N} \PY{o}{=} \PY{n}{n\PYZus{}max\PYZus{}wd}\PY{p}{,} \PY{n}{step} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{)}\PY{p}{,} \PY{n}{beta} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{n}{sigma} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}

\PY{c+c1}{\PYZsh{} laguerre\PYZus{}graph(4, 10)}
\end{Verbatim}
\end{tcolorbox}
...
Task 7:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
interactive(children=(IntSlider(value=1, description='T', max=10, min=1), IntSlider(value=5, description='N', …
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
<function \_\_main\_\_.laguerre\_graph(T, N, step=0.1, beta=2, sigma=4)>
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{sin\PYZus{}x\PYZus{}pow\PYZus{}2}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{x} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{2}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{x\PYZus{}pow\PYZus{}2}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{x} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{2}

\PY{k}{def} \PY{n+nf}{sqrt\PYZus{}x}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{x}\PY{p}{)}

\PY{n}{func\PYZus{}wd} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{Dropdown}\PY{p}{(}\PY{n}{options}\PY{o}{=}\PY{p}{[}\PY{n}{sin\PYZus{}x\PYZus{}pow\PYZus{}2}\PY{p}{,} \PY{n}{x\PYZus{}pow\PYZus{}2}\PY{p}{,} \PY{n}{sqrt\PYZus{}x}\PY{p}{]}\PY{p}{,} \PY{n}{value}\PY{o}{=}\PY{n}{sin\PYZus{}x\PYZus{}pow\PYZus{}2}\PY{p}{)}
\PY{n}{n\PYZus{}max\PYZus{}wd} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{IntSlider}\PY{p}{(}\PY{n+nb}{min} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{max} \PY{o}{=} \PY{l+m+mi}{20}\PY{p}{,} \PY{n}{value} \PY{o}{=} \PY{l+m+mi}{10}\PY{p}{)}

\PY{n}{ipywidgets}\PY{o}{.}\PY{n}{interact}\PY{p}{(}
    \PY{n}{reversed\PYZus{}transform\PYZus{}laguerre\PYZus{}graph}\PY{p}{,} 
    \PY{n}{f} \PY{o}{=} \PY{n}{func\PYZus{}wd}\PY{p}{,} 
    \PY{n}{N} \PY{o}{=} \PY{n}{n\PYZus{}max\PYZus{}wd}\PY{p}{,} 
    \PY{n}{T} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{pi} \PY{o}{*} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{n}{step} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{)}\PY{p}{,} \PY{n}{points} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mi}{1000}\PY{p}{)}\PY{p}{,} 
    \PY{n}{beta} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{n}{sigma} \PY{o}{=} \PY{n}{ipywidgets}\PY{o}{.}\PY{n}{fixed}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}

\PY{c+c1}{\PYZsh{} reversed\PYZus{}transform\PYZus{}laguerre\PYZus{}graph(test\PYZus{}f2, 20)}
\end{Verbatim}
\end{tcolorbox}

    
    \begin{Verbatim}[commandchars=\\\{\}]
interactive(children=(Dropdown(description='f', options=(<function sin\_x\_pow\_2 at 0x000001C2CF859F80>, <functi…
    \end{Verbatim}
